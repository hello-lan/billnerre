...
def load_pretrained_embedding(pretrain_dir):
    vocab_path = os.path.join(pretrain_dir,"vocab.pkl")
    embedding_path = os.path.join(pretrain_dir,"embedding.npy")
